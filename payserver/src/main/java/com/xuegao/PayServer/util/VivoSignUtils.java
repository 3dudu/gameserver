...
public class VivoSignUtils {
    ...
    static org.apache.log4j.Logger logger = Logger.getLogger(VivoSignUtils.class);
	...
	public static String getVivoSign(Map<String,String> para, String key) {
		...
		prestr = prestr + QSTRING_SPLIT + Misc.md5(key);
		return Misc.md5(prestr);
	}
	 ...
	 * @return
	 */
	public static String LinkString(Map<String, String> para, boolean sort) {

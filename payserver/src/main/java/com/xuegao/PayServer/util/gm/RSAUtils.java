package com.xuegao.PayServer.util.gm;
...
public class RSAUtils {
    ...
    /**
     * 公钥/私钥 编码后以 Base64 的格式
     */
    public static String encodedBase64(Key key) throws IOException {
        // 获取密钥编码后的格式
     ...
     * 客户端加密, 返回加密后的数据
     */
    public static byte[] clientEncrypt(byte[] plainData, String publicKey) throws Exception {
        // 读取公钥文件, 创建公钥对象
     ...
     * 服务端解密, 返回解密后的数据
     */
    public static byte[] serverDecrypt(byte[] cipherData, String privateKey) throws Exception {
        // 读取私钥文件, 创建私钥对象

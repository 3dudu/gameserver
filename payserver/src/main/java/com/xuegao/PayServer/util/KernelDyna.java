...
public abstract class KernelDyna {
	...
	/** DATE_FORMAT_FULL */
	public static final DateFormat DATE_FORMAT_FULL = new SimpleDateFormat("yyyyMMddHHmmss");

	/** DATE_FORMAT_ARRAY */
	public static final DateFormat[] DATE_FORMAT_ARRAY = new DateFormat[] { DATE_FORMAT, DATE_FORMAT_DAY, DATE_FORMAT_TIME,
			DATE_FORMAT_FULL, DateFormat.getDateTimeInstance(), DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG),
			DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.MEDIUM),
			new SimpleDateFormat("EEE MMM d hh:mm:ss a z yyyy"), new SimpleDateFormat("EEE MMM d HH:mm:ss z yyyy"),
			new SimpleDateFormat("MM/dd/yy hh:mm:ss a"), new SimpleDateFormat("MM/dd/yy") };

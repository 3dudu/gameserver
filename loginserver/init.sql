...
CREATE TABLE `player` (
  ...
  `uid` int(11) DEFAULT NULL COMMENT 'user表id',
  ...
  `diamond` int(11) DEFAULT NULL COMMENT '钻石数量',
  `battle_power` int(11) DEFAULT NULL COMMENT '战斗力',
...
-- 20190115 user表 增加platform字段
ALTER TABLE `user`
ADD COLUMN `channelCode` varchar(100) NOT NULL DEFAULT '0',
ADD COLUMN `lastLoginDate` varchar(50) NULL;

ALTER TABLE `user`
ADD INDEX `index_pf_user` (`pf_user`);
...
ADD COLUMN `uid` bigint NOT NULL DEFAULT '0';
